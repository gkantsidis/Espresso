...
namespace Espresso
{
    ...
    public ref class CubeInformation sealed
    {
    public:
        ...
        static property int NumberOfVariables
        {
            int get()
            {
                return cube.num_vars;
            }
        }

        static property int NumberOfBinaryVariables
        {
            int get()
            {
                return cube.num_binary_vars;
            }
        }

        static property Nullable<int> OutputVariable
        {
            Nullable<int> get()
            {
                const auto output = cube.output;
                if (output < 0)
                {
                    return Nullable<int>();
                }
        ...
        static property int NumberOfActiveVariables
        {
            int get()
            {
                return cdata.vars_active;
            }
        }

        static property int NumberOfUnateVariables
        {
            ///<summary>
            /// Counts the number of variables that have monotonic properties (unate)
            ///</summary>
            int get()
            {
                return cdata.vars_unate;
            }
        }

        static property int BestBinateVariable
        {
            ///<summary>
            /// Counts the number of variables that do have monotonic properties (they are binate and not unate)
            ///</summary>
            int get()
            {
                return cdata.best;
